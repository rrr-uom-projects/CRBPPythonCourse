...
exit() # Remove this line when you've finished task 1 to move on to task 2
#
#       TASK 2
#
...
exit() # Remove this line when you've finished task 2 to move on to task 3
#
#       TASK 3
#
...
plt.show() # Make the system actually draw the graph